---Context Rail design pack descriptor: defines metadata, schema tunables, and design defaults.
...
Designs.define {
  ...
  accent = '#ffffff',
  -- The rail draws its own mark on the world point, so the active indicator
  -- stands down while the list is up.
  hidesIndicator = true,
  -- Anchor coordinate: offset fraction relative to texture center
  anchor = { x = 0.34, y = 0.0 },
  -- Dynamic anchor positioning: adjust offset based on the side the list opens
  anchorRule = {
    key = 'listSide',
    values = {
      right = { x = 0.34, y = 0.0 },
  ...
  schema = Designs.extend(
    Designs.retune(
      -- No panels in this design: the list is drawn straight onto the world, so
      -- the surface-treatment controls have nothing to act on.
      Designs.commonSchemaExcept('surfaceAlpha', 'gradient', 'gradientDepth', 'corner', 'shadow'),
      {
    ...
    {
      { key = 'listSide', label = 'List opens', type = 'select', default = 'right', group = 'Design',
      ...
      { key = 'listWidth', label = 'Text column width', type = 'number', default = 680, min = 320, max = 820, step = 10, group = 'Design', unit = 'px',
        tier = 'basic', affects = 'menu',
        help = 'Width of the label column before text wraps.' },
      { key = 'visible', label = 'Rows in view', type = 'number', default = 5, min = 3, max = 8, step = 1, group = 'Design',
        tier = 'basic', affects = 'menu',
        help = 'How many rows are on screen at once. Longer lists scroll through the window.' },
      { key = 'focusEmphasis', label = 'Focus emphasis', type = 'number', default = 124, min = 100, max = 145, step = 1, group = 'Design', unit = '%',
        tier = 'basic', affects = 'menu',
        help = 'Size of the focused label against the rest of the list.' },
      { key = 'confirmGlyph', label = 'Confirm glyph', type = 'select', default = 'cross', group = 'Design',
        tier = 'basic', affects = 'menu',
        help = 'Mark drawn inside the focused rail node.',
        options = {
          { value = 'cross', label = 'Cross' }, { value = 'mouse', label = 'Mouse' },
          { value = 'dot', label = 'Dot' }, { value = 'none', label = 'Ring only' },
        } },
      { key = 'anchorMode', label = 'Focus behaviour', type = 'select', default = 'slot', group = 'Design',
      ...
      { key = 'rowGap', label = 'Row spacing', type = 'number', default = 86, min = 60, max = 140, step = 2, group = 'Design', unit = 'px',
        tier = 'advanced', affects = 'menu',
        help = 'Vertical distance between rows.' },
      { key = 'railStyle', label = 'Rail', type = 'select', default = 'line', group = 'Design',
        tier = 'advanced', affects = 'menu',
      ...
      { key = 'rowIcon', label = 'Option icons', type = 'select', default = 'none', group = 'Design',
        tier = 'advanced', affects = 'menu',
      ...
      { key = 'submenuGlyph', label = 'Submenu mark', type = 'select', default = 'dots', group = 'Design',
        tier = 'advanced', affects = 'menu',
      ...
      { key = 'textOutline', label = 'Text keyline', type = 'number', default = 60, min = 0, max = 100, step = 1, group = 'Surface', unit = '%',
        tier = 'basic', affects = 'menu',
        help = 'Contrast shadow drawn under every glyph.' },

      { key = 'fontFamily', label = 'Typeface', type = 'select', default = 'barlow', group = 'Typography',
        tier = 'basic', affects = 'menu',
