...
export const mock: MockDesign = {
  ...
  schema: [
    ...
    { key: 'confirmGlyph', label: 'Confirm glyph', type: 'select', default: 'cross', group: 'Design', tier: 'basic', affects: 'menu',
      help: 'Mark drawn inside the focused rail node.',
      options: [{ value: 'cross', label: 'Cross' }, { value: 'mouse', label: 'Mouse' }, { value: 'dot', label: 'Dot' }, { value: 'none', label: 'Ring only' }] },
